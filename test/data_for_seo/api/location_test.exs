defmodule DataForSeo.Api.LocationTest do
  ...
  setup do
    ...
    test "read locations by country", %{bypass: bypass} do
      ...
      assert Enum.any?(locations, & &1["location_type"] == "Country" and &1["location_name"] == "Luxembourg")
      assert Enum.any?(locations, & &1["location_type"] == "City" and &1["location_name"] == "Kaerjeng,Luxembourg")
